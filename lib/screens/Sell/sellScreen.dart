...
import 'package:spotbuy/provider/User/user_topup_provider.dart';
  ...
  Future<void> getDocId() async {
    ...
    await FirebaseFirestore.instance
        ...
        .then(
          ...
          cityDocIDs = docIDDemo.map((e) => e.toString()).toList();
          print("City Collection Docids:- $cityDocIDs");
        },
      ),
    );
  }
...
// Initial City Value
  ...
  Future<void> getCityTitles() async {
    print("Get function called");
    setState(() {
      if (cityTitlesDemo.length >= 2) {
        cityTitlesDemo = [
          'Select City',
        ];

        print('ReCalled $cityTitlesDemo');
      }
    });
    await FirebaseFirestore.instance
        .collection('City')
        ...
        .then(
          (snapshot) => snapshot.docs.forEach(
            (document) {
          cityTitlesDemo.add(document.get('Name'));
          setState(() {});

          cityTitles = cityTitlesDemo.map((e) => e.toString()).toList();
          print("Function data:- $cityTitles");
        },
      ),
    );
  }
  ...
  void savePost() async {
    ...
    Map<String, dynamic> obj = {
      ...
      'place': dropdownCityvalue + ' ' + dropdownStatevalue,
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          //         categoryDataList.add(snapshot.data!.docs[i].get("title"));
          //       }
          //     }
          //
          //
          ...
          //           // Initial Value
          //           value: dropdownCategoryvalue,
          //           items: categoryDataList.map((String dataList) {
                ...
                child: categoryDataList == null
                  ...
                  child: DropdownButton(
                    ...
                    onChanged: (String? newValue) {
                      ...
                      FirebaseFirestore.instance
                          .collection('Brand')
                          .where('Name', isEqualTo: dropdownBrandvalue)
                          .get()
                          .then(
                            (snapshot) => snapshot.docs.forEach(
                              (document) {
          ...
          //                 // Initial Value
          //                 value: dropdownBrandvalue,
          //                 items: brandDataList.map((String dataList) {
          //                   return DropdownMenuItem(
          //                     value: dataList,
          //                     child: Text(dataList),
          //                   );
          ...
          //                 isExpanded: true,
          //                 // Initial Value
          //                 value: dropdownVehiclevalue,
          //                 items: vehicleDataList.map((String dataList) {
          //                   return DropdownMenuItem(
          //                     value: dataList,
          //                     child: Text(dataList),
          //                   );
          ...
          StreamBuilder<QuerySnapshot>(
            stream:
            FirebaseFirestore.instance.collection('State').snapshots(),
            builder: (context, snapshot) {
              if (!snapshot.hasData) {
                return const Center(
                  child: CircularProgressIndicator(),
                ...
                child: stateDataList == null
                  ...
                  child: DropdownButton(
                    ...
                    onChanged: (String? newValue) {
                      ...
                      FirebaseFirestore.instance
                          .collection('State')
                          .where('Name', isEqualTo: dropdownStatevalue)
                          .get()
                          .then(
                            (snapshot) => snapshot.docs.forEach(
                              (document) {
              ...
              return Container(
                ...
                child: stateDataList == null
                  ...
                  child: DropdownButton(
                    ...
                    items: cityTitles.map((String dataList) {
                      return DropdownMenuItem(
                        value: dataList,
                        child: Text(dataList),
                      );
